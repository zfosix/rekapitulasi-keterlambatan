...
@section('content')
    <div class="container mt-1">
        <div class="text-dark">
            ...
            <p>Home / <a class="text-dark" href="{{ route('lates.index') }}">Data Keterlambatan</a> / Tambah Data
                Keterlambatan</p>
        </div>
        <a href="{{ route('lates.index') }}" c>
        ...
        <div class="card bg-primary-subtle mt-3 p-2">
            <div class="card-body">
                <h3>Form Penambahan Data Keterlambatan</h3>
                <form action="{{ route('lates.store') }}" enctype="multipart/form-data" method="post">
                    @csrf
                    ...
                    <button type="submit" class="btn btn-primary mt-4">Tambah Data Keterlambatan</button>
                </form>
            </div>
        </div>
    </div>
