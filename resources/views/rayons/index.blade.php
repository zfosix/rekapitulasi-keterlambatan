...
@section('content')
    <div class="container mx-6">
        ...
        <div class="d-flex justify-content-between mb-3">
            <form action="{{ route('rayons.search') }}" method="GET" class="flex-grow-1 me-2">
                <div class="input-group">
                    <input type="text" name="query" class="form-control bg-primary-subtle" placeholder="Cari Rayon">
            ...
            <a class="btn btn-info" href="{{ route('rayons.create') }}">
            ...
            <table class="table table-primary table-striped table-bordered">
                <thead>
                    <tr>
                        ...
                        <th class="text-center">Pembimbing Siswa</th>
                ...
                <tbody>
                    ...
                    @foreach ($rayons as $item)
                        <tr>
                            ...
                            <td class="text-center">{{ $item['rayon'] }}</td>
                            <td class="text-center">{{ $item->user->name }}</td>
                            <td class="text-center">
                                <a href="{{ route('rayons.edit', $item->id) }}" class="btn btn-info">
                                ...
                                <div class="modal fade" id="deleteConfirmation{{ $item->id }}" data-bs-backdrop="static"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body text-light">
                                                Yakin Anda Ingin Menghapus Data Rayon Ini?
                                            </div>
