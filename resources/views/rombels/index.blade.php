...
@section('content')
    <div class="container mx-6">
        ...
        <div class="d-flex justify-content-between mb-3">
            <form action="{{ route('rombels.search') }}" method="GET" class="flex-grow-1 me-2">
            ...
            <a class="btn btn-info" href="{{ route('rombels.create') }}">
                    ...
                    @foreach ($rombel as $item)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('rombels.edit', $item->id) }}" class="btn btn-info">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body text-light">
                                                Yakin Anda Ingin Menghapus Data Rombel Ini?
                                            </div>
