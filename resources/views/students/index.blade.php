    ...
    @if (Auth::check() && Auth::user()->role == 'ps')
        <div class="container mx-6">
            ...
            <div class="d-flex justify-content-between mb-3">
                <form action="{{ route('students.search') }}" method="GET" class="flex-grow-1 me-2">
                    ...
                    <tbody>
                        ...
                        @foreach ($students as $item)
                            <tr>
                                ...
                                <td class="text-center">{{ $item->rombel->rombel }}</td>
                                <td class="text-center">{{ $item->rayon->rayon }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
    ...
    @else
        <div class="container mx-6">
            ...
            <div class="d-flex justify-content-between mb-3">
                ...
                <a class="btn btn-info" href="{{ route('students.create') }}">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body text-light">
                                                    Yakin Anda Ingin Menghapus Data Siswa Ini?
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary"
                                                        data-bs-dismiss="modal">Close</button>
                                                    <form action="{{ route('students.delete', $item->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
